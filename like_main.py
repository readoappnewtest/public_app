...
import time
#for aryan
file = open('data_js.txt','r',encoding="utf-8")
json_data = file.read()
...
for api in json_js:
    ...
    try:
        ...
        if int(n%100) ==0:
            ...
            n = n + 1
        #=========================================================folow=====================================================================
        url = "http://video-user.pix.in/v1/post/follow/user"
        #for amb news
        ...
        #body = '{"card_ids":[]}'
        body = '{"follow_ids":["u8CU5TC9eBeongBvULTmFSlw4cY2"],"unfollow_ids":[]}'
        ...
        body = '{"like_ids":["sp_47zucb3cfb6sf"],"unlike_ids":[]}'
